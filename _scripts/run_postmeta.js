...
conn.on('ready', () => {
  conn.sftp((err, sftp) => {
    if (err) throw err;
    const local  = 'D:/DevTools/Database/2026chastnayadacha.ru/_scripts/get_postmeta.php';
    const remote = '/var/www/u2383407/data/www/chastnayadacha.ru/get_postmeta_tmp.php';
